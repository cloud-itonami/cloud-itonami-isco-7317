...
This project handles wood-and-basketry handicraft workshop operating
...
worker-safety risk (cut hazards, dust exposure, repetitive-strain injury).
...
- WoodBasketryGovernor bypass
- audit-ledger tampering
- over-disclosure in reports or exports
- unsafe robot action dispatch
- any path that lets a proposal reach a craft-fabrication-execution
