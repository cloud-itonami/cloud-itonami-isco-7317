...
`cloud-itonami-isco-7317` accepts contributions to the OSS actor, policy tests,
...
- Do not commit real worker, workshop or operator data, credentials or
  operating documents.
- Keep production writes and disclosures behind WoodBasketryGovernor.
...
- Never widen the closed op-allowlist to include a
  craft-fabrication-execution op, or a workshop-safety-officer-override op,
