(ns woodbasketry.actor
  "WoodBasketryActor — the ISCO-08 7317 wood-and-basketry handicraft
  ...
  The unconditional invariant: the Wood & Basketry Handicraft Workshop
  Advisor can never directly commit an operating record the
  WoodBasketryGovernor refuses, and can never make this actor finalize
  a craft-fabrication-execution decision (e.g. a specific carving,
  weaving or finishing step) or override a workshop safety officer's
  ...
  SCHEDULING/LOGISTICS ONLY — it never performs the craft fabrication
  work or authorizes craft-fabrication execution itself."
...
(defn build-graph
  "Build a compiled WoodBasketryActor graph. `store` implements
  `woodbasketry.store/Store`. `advisor` implements
  `woodbasketry.advisor/Advisor` (defaults to `mock-advisor`).
